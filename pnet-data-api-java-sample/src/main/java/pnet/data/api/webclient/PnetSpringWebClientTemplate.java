...
public final class PnetSpringWebClientTemplate {

    private static PnetDataApiLoginMethod loginMethod = null;

    private PnetSpringWebClientTemplate() {
        super();
    }
    ...
    public static void main(String[] args) throws PnetDataClientException {
        ...
        if (args.length == 1) {
            ...
            System.out.println(
                "Usage: java " + PnetSpringWebClientTemplate.class.getName() + " <TOKEN> | (<USERNAME> <PASSWORD>)"
            );
            System.exit(-1);
            return;
        }
        ...
        try (
            AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(
                PnetSpringWebClientTemplate.class
            );
        ) {
            context
