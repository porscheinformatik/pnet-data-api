 ...
 * @author ham
 */
public class ActivityBrandItemDTO implements WithTenant, WithMatchcode<BrandMatchcode>, Serializable
{
    ...
    public ActivityBrandItemDTO(@JsonProperty("tenant") Tenant tenant,
