 ...
 * @author ham
 */
public class InfoareaBrandItemDTO implements WithTenant, WithMatchcode<BrandMatchcode>, Serializable
{
    ...
    public InfoareaBrandItemDTO(@JsonProperty("tenant") Tenant tenant,
