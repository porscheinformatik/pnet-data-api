 ...
 * @author ham
 */
public class InfoareaBrandDataDTO implements WithTenant, WithMatchcode<BrandMatchcode>, Serializable
{
    ...
    public InfoareaBrandDataDTO(@JsonProperty("tenant") Tenant tenant,
