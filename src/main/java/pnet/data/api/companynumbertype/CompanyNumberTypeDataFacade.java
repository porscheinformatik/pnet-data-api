...
public interface CompanyNumberTypeDataFacade extends ByMatchcode<CompanyNumberTypeMatchcode, CompanyNumberTypeDataDTO>
{
    ...
    /**
     * Returns multiple {@link CompanyNumberTypeDataDTO}s each matching all specified restrictions. If one or more
    ...
    /**
     * Finds multiple {@link CompanyNumberTypeItemDTO}s each matching all specified restrictions. If one or more
     * restrictions are set each restriction will be applied (AND) and one of the values of each restriction must match
     * (OR).
     *
     * @param language the language
