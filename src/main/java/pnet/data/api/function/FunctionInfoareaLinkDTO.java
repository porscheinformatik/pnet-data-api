 ...
 * @author ham
 */
public class FunctionInfoareaLinkDTO
{

    private final Tenant tenant;
    private final InfoareaMatchcode infoareaMatchcode;

    public FunctionInfoareaLinkDTO(Tenant tenant, InfoareaMatchcode infoareaMatchcode)
    {
        super();
        this.tenant = tenant;
    ...
    public boolean equals(Object obj)
    {
        ...
        FunctionInfoareaLinkDTO other = (FunctionInfoareaLinkDTO) obj;
