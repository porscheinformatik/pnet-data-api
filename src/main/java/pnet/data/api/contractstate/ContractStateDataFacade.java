...
public interface ContractStateDataFacade extends ByMatchcode<ContractStateMatchcode, ContractStateDataDTO>
{
    ...
    /**
     * Returns multiple {@link ContractStateDataDTO}s each matching all specified filters. The method is limited to a
    ...
    Collection<ContractStateItemDTO> search(@RequestParam(value = "l") String language, @RequestParam("q") String query,
