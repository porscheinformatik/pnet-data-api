...
public interface ContractTypeDataFacade extends ByMatchcode<ContractTypeMatchcode, ContractTypeDataDTO>
{
    ...
    /**
     * Returns multiple {@link ContractTypeDataDTO}s each matching all specified filters. The method is limited to a
     ...
     * @param contractStateMatchcodes the matchcodes for contract states for filtering, optional
    ...
    Collection<ContractTypeItemDTO> search(@RequestParam(value = "l") String language, @RequestParam("q") String query,
