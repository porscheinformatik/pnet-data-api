...
-   `PersonDataDTO`, `PersonItemDTO` now have a `isLocked()` getter and a Collection of `PersonDataLockType` to check if the persons login is locked and the reasons why.
