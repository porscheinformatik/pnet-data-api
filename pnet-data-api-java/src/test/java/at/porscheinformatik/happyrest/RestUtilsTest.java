...
public class RestUtilsTest
{
    ...
    public void encodePathSegmentTest()
    {
        ...
        assertThat(RestUtils.encodePathSegment("-._~!$&'()*+,;=:@", StandardCharsets.UTF_8, false, false),
            is("-._~!$&'()*+,;=:@"));
        ...
        assertThat(RestUtils.encodePathSegment("ignore/slash", StandardCharsets.UTF_8, true, false),
            is("ignore/slash"));
    ...
    public void appendPathTest()
    {
        ...
        assertThat(RestUtils.appendPath("https://example.com", "path/{file}"),
            is("https://example.com/path/%7Bfile%7D"));
        assertThat(RestUtils.appendPathWithPlaceholders("https://example.com", "path/{file}"),
