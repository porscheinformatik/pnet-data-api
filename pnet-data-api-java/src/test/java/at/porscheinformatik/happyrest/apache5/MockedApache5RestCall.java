...
{
    public MockedApache5RestCall(CloseableHttpClient httpClient, RestLoggerAdapter loggerAdapter, String url,
    ...
    @Override
    protected MockedApache5RestCall copy(RestLoggerAdapter loggerAdapter, String url,
        List<MediaType> acceptableMediaTypes, MediaType contentType, List<RestAttribute> attributes,
        RestFormatter formatter, Object body)
    {
        return new MockedApache5RestCall(httpClient, loggerAdapter, url, acceptableMediaTypes, contentType, attributes,
    ...
    @Override
    public <T> MockedApache5RestResponse<T> invoke(RestMethod method, GenericType<T> responseType) throws RestException
    {
        return (MockedApache5RestResponse<T>) super.invoke(method, responseType);
    }
