...
public class MockedApache5RestCallFactory extends Apache5RestCallFactory
{
    ...
    @Override
    protected MockedApache5RestCallFactory copy(RestLoggerAdapter loggerAdapter, RestFormatter formatter,
    ...
    {
        return new MockedApache5RestCall(httpClient, loggerAdapter, url, null, MediaType.APPLICATION_JSON, null,
