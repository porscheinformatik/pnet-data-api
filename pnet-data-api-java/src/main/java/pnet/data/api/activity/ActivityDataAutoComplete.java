 ...
 * @author ham
 */
public class ActivityDataAutoComplete
    extends AbstractAutoComplete<ActivityAutoCompleteDTO, ActivityDataAutoComplete>
    implements
        RestrictTenant<ActivityDataAutoComplete>,
        RestrictBrand<ActivityDataAutoComplete>,
        RestrictCompanyType<ActivityDataAutoComplete>,
        RestrictContractType<ActivityDataAutoComplete>,
        RestrictVisibility<ActivityDataAutoComplete>,
        RestrictAssignableToRegular<ActivityDataAutoComplete>,
        RestrictAssignableToPrivileged<ActivityDataAutoComplete>,
        RestrictApprovalNeeded<ActivityDataAutoComplete>,
        IncludeInactive<ActivityDataAutoComplete> {

    public ActivityDataAutoComplete(
        AutoCompleteFunction<ActivityAutoCompleteDTO> autoCompleteFunction,
