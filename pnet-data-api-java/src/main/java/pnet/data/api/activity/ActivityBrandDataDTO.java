 ...
 * @author ham
 */
public class ActivityBrandDataDTO implements WithTenant, WithMatchcode, Serializable
{
    ...
    public ActivityBrandDataDTO(@JsonProperty("tenant") String tenant, @JsonProperty("matchcode") String matchcode)
    {
        super();
