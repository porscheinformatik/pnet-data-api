 ...
 * @author ham
 */
public class FunctionActivityDataDTO implements WithTenant, WithMatchcode, Serializable
{
    ...
    public FunctionActivityDataDTO(@JsonProperty("tenant") String tenant, @JsonProperty("matchcode") String matchcode)
    {
        super();
