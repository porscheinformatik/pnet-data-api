 ...
 * @author cet
 */
public class FunctionDataGet extends AbstractGet<FunctionDataDTO, FunctionDataGet> implements
    RestrictTenant<FunctionDataGet>, IncludeInactive<FunctionDataGet>, ByMatchcode<FunctionDataDTO, FunctionDataGet>
{
