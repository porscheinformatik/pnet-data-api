 ...
 * @author cet
 */
public class CompanyGroupDataGet
    extends AbstractScrollableGet<CompanyGroupDataDTO, CompanyGroupDataGet>
    implements
        RestrictLeadingCompanyId<CompanyGroupDataGet>,
        RestrictLeadingCompanyNumber<CompanyGroupDataGet>,
        RestrictLeadingCompany<CompanyGroupDataGet>,
    ...
    public PnetDataClientResultPage<CompanyGroupDataDTO> allByLeadingCompanyIds(
        List<Integer> leadingCompanyIds,
        int pageIndex,
        int itemsPerPage
    ...
    public PnetDataClientResultPage<CompanyGroupDataDTO> allByCompanyIds(
    ...
    public PnetDataClientResultPage<CompanyGroupDataDTO> allByLeadingCompanyNumbers(
        List<String> leadingCompanyNumbers,
        int pageIndex,
        int itemsPerPage
    ) throws PnetDataClientException {
    ...
    public PnetDataClientResultPage<CompanyGroupDataDTO> allByCompanyNumbers(
    ...
    public PnetDataClientResultPage<CompanyGroupDataDTO> allByLeadingCompanies(
        List<String> leadingCompanyMatchcodes,
        int pageIndex,
        int itemsPerPage
    ) throws PnetDataClientException {
    ...
    public PnetDataClientResultPage<CompanyGroupDataDTO> allByCompanies(
        List<String> companyMatchcodes,
        int pageIndex,
        int itemsPerPage
    ) throws PnetDataClientException {
    ...
    public PnetDataClientResultPage<CompanyGroupDataDTO> allByCompanyGroupTypes(
        List<String> companyGroupTypes,
        int pageIndex,
        int itemsPerPage
    ) throws PnetDataClientException {
