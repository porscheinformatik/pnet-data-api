...
public interface AdvisorTypeDataFacade extends ByMatchcode<AdvisorTypeDataDTO>
{
    ...
    /**
     * Returns multiple {@link AdvisorTypeDataDTO}s each matching all specified restrictions. If one or more
    ...
    ResultPage<AdvisorTypeItemDTO> search(@RequestParam(value = "l") String language, @RequestParam("q") String query,
    ...
    /**
     * Finds multiple {@link AdvisorTypeItemDTO}s each matching all specified restrictions. If one or more restrictions
