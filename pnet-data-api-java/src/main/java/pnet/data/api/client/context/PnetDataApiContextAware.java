...
public interface PnetDataApiContextAware<SELF>
{
     ...
     *             {@link PnetDataApiLoginMethod}s that may not be compatible with the concepts of "URLs". Instead of
     *             calling this method, you may create a new {@link PnetDataApiLoginMethod} and use the
     ...
     * @return the object itself or a new instance
     * @deprecated There is no direct replacement for this method. Since version 1.20 you may use different
     *             {@link PnetDataApiLoginMethod}s that may not be compatible with the concepts of "username" and
     *             "password". Instead of calling this method, you may create a new {@link PnetDataApiLoginMethod} and
     *             use the {@link #withLoginMethod(PnetDataApiLoginMethod)} method to set it.
     */
    @Deprecated
