...
public final class Tenant extends Matchcode
{
    ...
    /**
     * Creates a collection of tenants
     *
     * @param tenants the tenants
     * @return a collection, never null
     */
    public static Collection<Tenant> ofAll(String... tenants)
    {
        return ofAll(Arrays.asList(tenants));
    }

    /**
     * Creates a collection of tenants
     *
     * @param tenants the tenants, may be null
