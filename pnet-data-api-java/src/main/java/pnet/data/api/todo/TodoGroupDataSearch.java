...
public class TodoGroupDataSearch
    ...
    RestrictAssignedToPersonId<TodoGroupDataSearch>, AggregateNumberPerCategory<TodoGroupDataSearch>,
    AggregateNumberPerState<TodoGroupDataSearch>, RestrictQueryField<TodoGroupDataSearch>
{
