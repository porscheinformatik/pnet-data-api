...
public class PersonAggregationsDTO {
    ...
    public PersonAggregationsDTO(
        @JsonProperty("tenants") List<PersonTenantAggregationDTO> tenants,
    ...
    public String toString() {
        return String.format(
            "PersonAggregationsDTO [tenants=%s, companies=%s, functions=%s, activities=%s]",
            tenants,
            companies,
            functions,
            activities
