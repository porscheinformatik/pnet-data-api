...
public class PersonLockLinkDTO implements Serializable {
    ...
    public PersonLockLinkDTO(
        @JsonProperty("type") PersonLockType type,
        @JsonProperty("lockedAt") LocalDateTime lockedAt,
        @JsonProperty("lockedByGpId") Integer lockedByGpId
    ) {
        this.type = type;
    ...
    public String toString() {
        return String.format(
            "%s[type=%s, lockedAt=%s, lockedByGpId=%s]",
