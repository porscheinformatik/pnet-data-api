...
public class PersonDataAutoComplete extends AbstractAutoComplete<PersonAutoCompleteDTO, PersonDataAutoComplete>
    ...
    RestrictCompanyNumber<PersonDataAutoComplete>, RestrictCompany<PersonDataAutoComplete>, RestrictFunction<PersonDataAutoComplete>,
    RestrictActivity<PersonDataAutoComplete>, CompanyMergable<PersonDataAutoComplete>
{

    public PersonDataAutoComplete(AutoCompleteFunction<PersonAutoCompleteDTO> autoCompleteFunction, List<Pair<String, Object>> restrictItems)
    {
