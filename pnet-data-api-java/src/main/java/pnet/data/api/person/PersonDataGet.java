 ...
 * @author cet
 */
public class PersonDataGet
    extends AbstractGet<PersonDataDTO, PersonDataGet>
    implements
        RestrictTenant<PersonDataGet>,
        RestrictExternalId<PersonDataGet>,
        RestrictGuid<PersonDataGet>,
        ...
        RestrictApproved<PersonDataGet>,
        IncludeInactive<PersonDataGet>,
        ById<Integer, PersonDataDTO, PersonDataGet> {
    ...
    public PnetDataClientResultPage<PersonDataDTO> allByExternalIds(
    ...
    public PnetDataClientResultPage<PersonDataDTO> allByPreferredUserIds(
        List<String> preferredUserIds,
        int pageIndex,
        int itemsPerPage
    ) throws PnetDataClientException {
