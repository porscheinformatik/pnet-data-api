 ...
 * @author cet
 */
public class CompanyNumberTypeDataGet
    extends AbstractGet<CompanyNumberTypeDataDTO, CompanyNumberTypeDataGet>
    implements ByMatchcode<CompanyNumberTypeDataDTO, CompanyNumberTypeDataGet> {

    public CompanyNumberTypeDataGet(
        GetFunction<CompanyNumberTypeDataDTO> getFunction,
