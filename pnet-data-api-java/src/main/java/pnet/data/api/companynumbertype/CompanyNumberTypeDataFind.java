 ...
 * @author cet
 */
public class CompanyNumberTypeDataFind
    extends AbstractFind<CompanyNumberTypeItemDTO, CompanyNumberTypeDataFind>
    implements RestrictMatchcode<CompanyNumberTypeDataFind>, RestrictUpdatedAfter<CompanyNumberTypeDataFind> {

    public CompanyNumberTypeDataFind(
        FindFunction<CompanyNumberTypeItemDTO> findFunction,
