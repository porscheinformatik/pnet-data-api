 ...
 * @author ham
 */
@ApiModel(description = "Holds basic information about a contract state")
public class ContractStateItemDTO implements WithMatchcode, WithLabel, WithLastUpdate, Serializable
{
    ...
    @ApiModelProperty(notes = "The label of the contract state in the requested language")
