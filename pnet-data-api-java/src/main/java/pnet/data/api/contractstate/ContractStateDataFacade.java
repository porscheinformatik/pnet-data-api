...
public interface ContractStateDataFacade extends ByMatchcode<ContractStateDataDTO>
{
    ...
    /**
     * Returns multiple {@link ContractStateDataDTO}s each matching all specified restrictions. If one or more
    ...
    /**
     * Finds multiple {@link ContractStateItemDTO}s each matching all specified restrictions. If one or more
     * restrictions are set each restriction will be applied (AND) and one of the values of each restriction must match
     * (OR).
     *
     * @param language the language
