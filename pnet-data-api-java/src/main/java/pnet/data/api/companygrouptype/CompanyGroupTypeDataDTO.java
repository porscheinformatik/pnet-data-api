 ...
 * @author ham
 */
@ApiModel(description = "Holds all information about a company group type")
public class CompanyGroupTypeDataDTO implements WithMatchcode, WithLabels, WithLastUpdate, Serializable
{
    ...
    @ApiModelProperty(notes = "The label of the company group type with all existing translations")
