...
@Configuration
public class Apache5HttpClientBasedRestCallFactoryConfig extends PnetDataRestCallFactoryConfig {

    protected Apache5HttpClientBasedRestCallFactoryConfig(
    ...
    @Bean
    public RestCallFactory apache5HttpClientBasedRestCallFactory() {
        ObjectMapper objectMapper = objectMapper();
        RestLoggerAdapter loggerAdapter = restLoggerAdapter();
        ConversionService conversionService = conversionService();

        return Apache5RestCallFactory.create(loggerAdapter, objectMapper)
