...
public interface MockFilters
{
    ...
    static <ContainerT, CollectionT extends Collection<ValueT>, ValueT> BiPredicate<ContainerT, ValueT> whenCollectionContains(
        Function<ContainerT, CollectionT> getter)
    {
    ...
    static <ContainerT, InnerContainerT, CollectionT extends Collection<InnerContainerT>, ValueT> BiPredicate<ContainerT, ValueT> withCollection(
        Function<ContainerT, CollectionT> collectionGetter, BiPredicate<InnerContainerT, ValueT> predicate)
    {
        return (container, value) -> {
