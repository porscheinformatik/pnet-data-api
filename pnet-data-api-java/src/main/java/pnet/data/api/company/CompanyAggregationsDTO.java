...
public class CompanyAggregationsDTO {
    ...
    public CompanyAggregationsDTO(
        @JsonProperty("tenants") List<CompanyTenantAggregationDTO> tenants,
    ...
    public String toString() {
        return String.format(
            "CompanyAggregationsDTO [tenants=%s, brands=%s, types=%s, contractTypes=%s]",
            tenants,
            brands,
            types,
            contractTypes
